...
{
    /// <summary>
    /// kubeconfig configuration model for printing to screen and writing to file. 
    /// Needed to preserve ordering of YAML elements
    /// Holds the information needed to build connect to remote
    /// Kubernetes clusters as a given user.
    /// </summary>
    /// <remarks>
    /// Should be kept in sync with:
    ///     https://github.com/kubernetes-client/csharp/blob/master/src/KubeConfigModels/K8SConfiguration.cs
    ///     https://github.com/kubernetes/kubernetes/blob/master/staging/src/k8s.io/client-go/tools/clientcmd/api/v1/types.go
    /// </remarks>
    public class K8SConfigurationOutput
    {
